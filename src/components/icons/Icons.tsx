// أيقونات مع حجم قابل للتخصيص
export interface IconProps {
  size?: number;
  className?: string;
}

// أيقونات SVG المتقدمة (بديلة للإيموجي)
...
export const ClipboardList = ({ size = 24, className = "" }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const Printer = ({ size = 24, className = "" }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const Medal = ({ size = 24, className = "" }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="12" cy="8" r="7"></circle>
    <polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline>
  </svg>
...
// إذا كنت ترغب في استخدام أيقونات الإيموجي البسيطة بدلاً من SVG،
// يمكنك استخدام التعريفات البديلة أدناه. لتفعيلها، قم بإزالة التعليق
// وتعليق التعريفات المقابلة أعلاه.

/*
// تعريف الأيقونات كمكونات React بسيطة باستخدام الإيموجي
